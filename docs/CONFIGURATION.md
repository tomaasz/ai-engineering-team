...
These are time and iteration limits. They do not track tokens or cost, and an interrupted run is not resumed automatically. Direct subprocess timeout may leave descendant processes on some platforms.
