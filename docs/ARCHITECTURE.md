...
Every run records its base ref, branch, prompt, stage outputs, stderr, check logs, and canonical `.ai/runs/<run-id>/result.json`. By default, a generated branch is used. No automated commit, push, merge, or deployment takes place.
